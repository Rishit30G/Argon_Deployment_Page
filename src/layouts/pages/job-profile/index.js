  ...
  return (
    <DashboardLayout>
      ...
      <ArgonBox px={3} py={3}>
        ...
        <img src="https://i.postimg.cc/CL0H2938/1026px-Uniswap-Logo-svg-1.png" alt="placeholder" style={{borderRadius: '50%', height: '130px', width: '130px'}}/>
            ...
            <Grid container direction="column" spacing={3}>
              ...
              <Grid item>
                ...
                <ArgonTypography variant="body2">
                  ...
                  is needed to make our customers use our solutions effectively. In addition to the
                  above you must possess the following competency & attributes: • Demonstrates
                  knowledge of software development techniques and fluency in software languages and
                  application programming interfaces. • Demonstrates in-depth understanding of
                  hardware/software platforms including but not limited to operating systems,
                  databases, application servers, web servers and integration technologies. • Plans
                  and executes system implementations that ensure success and minimize risk of
              ...
              <Grid item>
                ...
                <ArgonTypography variant="body2">
                  ...
                  announcement on choosing the candidates will be made at the end of the recruitment
                  process.
                </ArgonTypography>
              </Grid>
