            ...
            <CardContent>
              <Grid container spacing={8}>
                <Grid container item xs={12} sm={12} md={12} justifyContent="space-between" alignItems="center">
                  ...
                  <ArgonButton style={{ height: "52px", width: "200px", fontSize: '17px', fontWeight: '400', backgroundColor: "black", border: "1px solid #8d8d8d", color: 'white', boxShadow: '5px 5px 10px  #B721BE'}}> Check Proposal </ArgonButton>
                </Grid>
